...
import quoteSectionBackground from "../assets/quote-section-background.png";
import {
  cardClass,
  dashboardGrid,
  subHeadingClass,
...
const QuoteCardVisual = ({ text }) => {
  return (
    <div
      className="relative isolate overflow-hidden rounded-lg border border-[#D7E4D1] bg-cover bg-center px-5 py-8 sm:px-10 sm:py-9 shadow-[inset_0_1px_0_rgba(255,255,255,0.75),0_12px_26px_rgba(24,76,56,0.08)] transition duration-300 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_16px_32px_rgba(24,76,56,0.11)]"
      style={{ backgroundImage: `url(${quoteSectionBackground})` }}
    >
      <div className="relative z-10 mx-auto flex min-h-28 max-w-[72%] items-center justify-center text-center sm:max-w-[62%] lg:max-w-[58%]">
        <p className="text-xl sm:text-2xl lg:text-3xl font-semibold leading-[1.45] tracking-[0.08em] text-[#123F31] [font-family:Georgia,serif] drop-shadow-[0_1px_0_rgba(255,255,255,0.5)]">
          <span className="text-[#1F7A58]/85">&quot;</span>
          {text}
          <span className="text-[#1F7A58]/85">&quot;</span>
        </p>
      </div>
